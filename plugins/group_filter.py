...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"𝗛𝗲𝗿𝗲 𝗶𝘀 𝘄𝗵𝗮𝘁 𝗶 𝗳𝗼𝘂𝗻𝗱 𝗳𝗼𝗿 𝘆𝗼𝘂𝗿 𝗾𝘂𝗲𝗿𝘆  {search}          🔗 𝗝𝗼𝗶𝗻 : @Mafia_Links 🔗 ...            𝗧𝗿𝘆 𝗧𝗼 𝗙𝗼𝗿𝘄𝗮𝗿𝗱 𝗧𝗵𝗶𝘀 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 𝘁𝗼 𝗦𝗮𝘃𝗲𝗱 𝗠𝗲𝘀𝘀𝗮𝗴𝗲𝘀 𝗼𝗿 𝘁𝗼 𝗼𝘂𝗿 𝗙𝗿𝗶𝗲𝗻𝗱            𝗜𝘁 𝘄𝗶𝗹𝗹 𝗯𝗲 𝗱𝗲𝗹𝗲𝘁𝗲𝗱 𝗮𝗳𝘁𝗲𝗿 𝟮 𝗺𝗶𝗻𝘂𝘁𝗲𝘀"
